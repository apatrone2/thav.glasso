...
graph_comparison <- function(n, d, type="random")
{
  ...
  png(paste0(path_plots, "true_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  ...
  png(paste0(path_plots, "oracle_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "thav_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "stars_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "scaledlasso_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "tiger_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "sciocv_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "sciobregman_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "score_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "thav_rsme_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
  ...
  png(paste0(path_plots, "thav_sf_graphn", n, "d", d, ".png"), width=1000, height=800, res=200)
  par(mar=c(0, 0, 0, 0) + 0.1)
...
visualization_differentC <- function(n, d, seq_C=c(0.5, 0.6, 0.7, 0.8), graph="random", add_title=FALSE)
{
  ...
  for(j in 1:length(seq_C))
  {
    ...
    {
      png(paste0("../plots/", graph, "/n", n, "d",d, "/different_C/C", seq_C[j], ".png"), width=1000, height=1000, res=200)
      par(mar=c(0, 0, 0, 0) + 0.1)
